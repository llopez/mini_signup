...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_list2.default, { url: "/api/users" }), document.getElementById('app'));
	  ...
	  _createClass(List, [{
	    ...
	    value: function render() {
	      var items = this.state.data.map(function (item) {
	        return _react2.default.createElement(_item2.default, { firstName: item.data.first_name, lastName: item.data.last_name, age: item.data.age, key: item.data.id });
	      });
